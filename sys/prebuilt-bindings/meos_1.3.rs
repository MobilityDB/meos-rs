...
extern "C" {
    pub fn rtree_insert(rtree: *mut RTree, box_: *mut ::std::os::raw::c_void, id: int64);
}
extern "C" {
    pub fn rtree_search(
        rtree: *const RTree,
...
extern "C" {
    pub fn int64_cmp(l: int64, r: int64) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn interval_make(
        years: int32,
        months: int32,
        weeks: int32,
        days: int32,
...
extern "C" {
    pub fn set_split_each_n_spans(
        s: *const Set,
        elems_per_span: ::std::os::raw::c_int,
        count: *mut ::std::os::raw::c_int,
    ) -> *mut Span;
}
extern "C" {
...
extern "C" {
    pub fn temporal_to_tsequenceset(temp: *const Temporal, interp: interpType)
        -> *mut TSequenceSet;
}
extern "C" {
...
extern "C" {
    pub fn tdistance_tnumber_tnumber(
        temp1: *const Temporal,
        temp2: *const Temporal,
    ) -> *mut Temporal;
}
...
extern "C" {
    pub fn tfloat_value_time_boxes(
        temp: *const Temporal,
        vsize: f64,
        duration: *const Interval,
        vorigin: f64,
...
extern "C" {
    pub fn tint_value_split(
        ...
        vsize: ::std::os::raw::c_int,
        vorigin: ::std::os::raw::c_int,
        bins: *mut *mut ::std::os::raw::c_int,
        count: *mut ::std::os::raw::c_int,
    ) -> *mut *mut Temporal;
}
extern "C" {
    pub fn tint_value_time_boxes(
        temp: *const Temporal,
        vsize: ::std::os::raw::c_int,
        duration: *const Interval,
        vorigin: ::std::os::raw::c_int,
...
extern "C" {
    pub fn geo_from_text(wkt: *const ::std::os::raw::c_char, srid: i32) -> *mut GSERIALIZED;
}
extern "C" {
...
extern "C" {
    pub fn geogpoint_make2d(srid: i32, x: f64, y: f64) -> *mut GSERIALIZED;
}
extern "C" {
    pub fn geogpoint_make3dz(srid: i32, x: f64, y: f64, z: f64) -> *mut GSERIALIZED;
}
extern "C" {
    pub fn geompoint_make2d(srid: i32, x: f64, y: f64) -> *mut GSERIALIZED;
}
extern "C" {
    pub fn geompoint_make3dz(srid: i32, x: f64, y: f64, z: f64) -> *mut GSERIALIZED;
}
extern "C" {
...
extern "C" {
    pub fn geom_azimuth(gs1: *const GSERIALIZED, gs2: *const GSERIALIZED, result: *mut f64)
        -> bool;
}
extern "C" {
...
extern "C" {
    pub fn geo_set_srid(gs: *const GSERIALIZED, srid: i32) -> *mut GSERIALIZED;
}
extern "C" {
...
extern "C" {
    pub fn geo_transform_pipeline(
        gs: *const GSERIALIZED,
        pipeline: *mut ::std::os::raw::c_char,
        srid_to: i32,
        is_forward: bool,
    ) -> *mut GSERIALIZED;
}
extern "C" {
    pub fn geo_collect_garray(
        gsarr: *mut *mut GSERIALIZED,
        count: ::std::os::raw::c_int,
    ) -> *mut GSERIALIZED;
}
extern "C" {
    pub fn geo_makeline_garray(
        gsarr: *mut *mut GSERIALIZED,
        count: ::std::os::raw::c_int,
    ) -> *mut GSERIALIZED;
}
...
extern "C" {
    pub fn geom_shortestline3d(gs1: *const GSERIALIZED, s2: *const GSERIALIZED)
        -> *mut GSERIALIZED;
}
extern "C" {
...
extern "C" {
    pub fn geog_dwithin(
        g1: *const GSERIALIZED,
        g2: *const GSERIALIZED,
        tolerance: f64,
        use_spheroid: bool,
    ) -> bool;
}
extern "C" {
    pub fn geog_intersects(
        gs1: *const GSERIALIZED,
        gs2: *const GSERIALIZED,
        use_spheroid: bool,
    ) -> bool;
...
extern "C" {
    pub fn geom_dwithin2d(gs1: *const GSERIALIZED, gs2: *const GSERIALIZED, tolerance: f64)
        -> bool;
}
extern "C" {
    pub fn geom_dwithin3d(gs1: *const GSERIALIZED, gs2: *const GSERIALIZED, tolerance: f64)
        -> bool;
}
extern "C" {
...
extern "C" {
    pub fn geom_relate_pattern(
        gs1: *const GSERIALIZED,
        gs2: *const GSERIALIZED,
        patt: *mut ::std::os::raw::c_char,
    ) -> bool;
}
extern "C" {
...
extern "C" {
    pub fn geo_split_each_n_stboxes(
        gs: *const GSERIALIZED,
        elem_count: ::std::os::raw::c_int,
        count: *mut ::std::os::raw::c_int,
    ) -> *mut STBox;
...
extern "C" {
    pub fn spatialset_as_text(
        set: *const Set,
        maxdd: ::std::os::raw::c_int,
    ) -> *mut ::std::os::raw::c_char;
}
extern "C" {
    pub fn spatialset_as_ewkt(
        set: *const Set,
        maxdd: ::std::os::raw::c_int,
    ) -> *mut ::std::os::raw::c_char;
}
...
extern "C" {
    pub fn spatialset_set_srid(s: *const Set, srid: i32) -> *mut Set;
}
extern "C" {
    pub fn spatialset_srid(s: *const Set) -> i32;
}
extern "C" {
    pub fn spatialset_transform(s: *const Set, srid: i32) -> *mut Set;
}
extern "C" {
    pub fn spatialset_transform_pipeline(
        s: *const Set,
...
extern "C" {
    pub fn stbox_set_srid(box_: *const STBox, srid: i32) -> *mut STBox;
}
extern "C" {
    pub fn stbox_srid(box_: *const STBox) -> i32;
}
extern "C" {
    pub fn stbox_transform(box_: *const STBox, srid: i32) -> *mut STBox;
}
extern "C" {
...
extern "C" {
    pub fn tgeoseq_from_base_tstzspan(
        gs: *const GSERIALIZED,
        s: *const Span,
        interp: interpType,
    ) -> *mut TSequence;
...
extern "C" {
    pub fn tgeoseqset_from_base_tstzspanset(
        gs: *const GSERIALIZED,
        ss: *const SpanSet,
        interp: interpType,
    ) -> *mut TSequenceSet;
...
extern "C" {
    pub fn tpointseq_make_coords(
        xcoords: *const f64,
        ycoords: *const f64,
        zcoords: *const f64,
        times: *const TimestampTz,
        count: ::std::os::raw::c_int,
        srid: int32,
        geodetic: bool,
        lower_inc: bool,
...
extern "C" {
    pub fn tgeo_value_at_timestamptz(
        temp: *const Temporal,
        t: TimestampTz,
        strict: bool,
...
extern "C" {
    pub fn tspatial_srid(temp: *const Temporal) -> i32;
}
extern "C" {
    pub fn tspatial_set_srid(temp: *const Temporal, srid: i32) -> *mut Temporal;
}
extern "C" {
    pub fn tspatial_transform(temp: *const Temporal, srid: i32) -> *mut Temporal;
}
extern "C" {
    pub fn tspatial_transform_pipeline(
        temp: *const Temporal,
        pipelinestr: *const ::std::os::raw::c_char,
        srid: i32,
        is_forward: bool,
...
extern "C" {
    pub fn always_eq_geo_tgeo(
        gs: *const GSERIALIZED,
        temp: *const Temporal,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn always_eq_tgeo_geo(
        temp: *const Temporal,
        gs: *const GSERIALIZED,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn always_eq_tgeo_tgeo(
        temp1: *const Temporal,
        temp2: *const Temporal,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn always_ne_geo_tgeo(
        gs: *const GSERIALIZED,
        temp: *const Temporal,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn always_ne_tgeo_geo(
        temp: *const Temporal,
        gs: *const GSERIALIZED,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn always_ne_tgeo_tgeo(
        temp1: *const Temporal,
        temp2: *const Temporal,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn ever_eq_geo_tgeo(gs: *const GSERIALIZED, temp: *const Temporal)
        -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn ever_eq_tgeo_geo(temp: *const Temporal, gs: *const GSERIALIZED)
        -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn ever_eq_tgeo_tgeo(
        temp1: *const Temporal,
        temp2: *const Temporal,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn ever_ne_geo_tgeo(gs: *const GSERIALIZED, temp: *const Temporal)
        -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn ever_ne_tgeo_geo(temp: *const Temporal, gs: *const GSERIALIZED)
        -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn ever_ne_tgeo_tgeo(
        temp1: *const Temporal,
        temp2: *const Temporal,
    ) -> ::std::os::raw::c_int;
}
...
extern "C" {
    pub fn tgeo_split_each_n_stboxes(
        temp: *const Temporal,
        elem_count: ::std::os::raw::c_int,
        count: *mut ::std::os::raw::c_int,
    ) -> *mut STBox;
...
extern "C" {
    pub fn acontains_geo_tgeo(
        gs: *const GSERIALIZED,
        temp: *const Temporal,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn acontains_tgeo_geo(
        temp: *const Temporal,
        gs: *const GSERIALIZED,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn acontains_tgeo_tgeo(
        temp1: *const Temporal,
        temp2: *const Temporal,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn adisjoint_tgeo_geo(
        temp: *const Temporal,
        gs: *const GSERIALIZED,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn adisjoint_tgeo_tgeo(
        temp1: *const Temporal,
        temp2: *const Temporal,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn adwithin_tgeo_geo(
        temp: *const Temporal,
        gs: *const GSERIALIZED,
        dist: f64,
    ) -> ::std::os::raw::c_int;
...
extern "C" {
    pub fn aintersects_tgeo_geo(
        temp: *const Temporal,
        gs: *const GSERIALIZED,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn aintersects_tgeo_tgeo(
        temp1: *const Temporal,
        temp2: *const Temporal,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn atouches_tgeo_geo(
        temp: *const Temporal,
        gs: *const GSERIALIZED,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn atouches_tgeo_tgeo(
        temp1: *const Temporal,
        temp2: *const Temporal,
    ) -> ::std::os::raw::c_int;
}
...
extern "C" {
    pub fn econtains_geo_tgeo(
        gs: *const GSERIALIZED,
        temp: *const Temporal,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn econtains_tgeo_geo(
        temp: *const Temporal,
        gs: *const GSERIALIZED,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn econtains_tgeo_tgeo(
        temp1: *const Temporal,
        temp2: *const Temporal,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn ecovers_geo_tgeo(gs: *const GSERIALIZED, temp: *const Temporal)
        -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn ecovers_tgeo_geo(temp: *const Temporal, gs: *const GSERIALIZED)
        -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn ecovers_tgeo_tgeo(
        temp1: *const Temporal,
        temp2: *const Temporal,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn edisjoint_tgeo_geo(
        temp: *const Temporal,
        gs: *const GSERIALIZED,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn edisjoint_tgeo_tgeo(
        temp1: *const Temporal,
        temp2: *const Temporal,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn edwithin_tgeo_geo(
        temp: *const Temporal,
        gs: *const GSERIALIZED,
        dist: f64,
    ) -> ::std::os::raw::c_int;
...
extern "C" {
    pub fn eintersects_tgeo_geo(
        temp: *const Temporal,
        gs: *const GSERIALIZED,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn eintersects_tgeo_tgeo(
        temp1: *const Temporal,
        temp2: *const Temporal,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn etouches_tgeo_geo(
        temp: *const Temporal,
        gs: *const GSERIALIZED,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn etouches_tgeo_tgeo(
        temp1: *const Temporal,
        temp2: *const Temporal,
    ) -> ::std::os::raw::c_int;
}
...
extern "C" {
    pub fn shortestline_tgeo_geo(temp: *const Temporal, gs: *const GSERIALIZED)
        -> *mut GSERIALIZED;
}
extern "C" {
    pub fn shortestline_tgeo_tgeo(
        temp1: *const Temporal,
        temp2: *const Temporal,
    ) -> *mut GSERIALIZED;
}
...
extern "C" {
    pub fn geo_cluster_kmeans(
        geoms: *mut *const GSERIALIZED,
        ngeoms: u32,
        k: u32,
    ) -> *mut ::std::os::raw::c_int;
}
extern "C" {
    pub fn geo_cluster_dbscan(
        geoms: *mut *const GSERIALIZED,
        ngeoms: u32,
        tolerance: f64,
...
extern "C" {
    pub fn geo_cluster_intersecting(
        geoms: *mut *const GSERIALIZED,
        ngeoms: u32,
        count: *mut ::std::os::raw::c_int,
    ) -> *mut *mut GSERIALIZED;
